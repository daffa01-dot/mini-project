...
// 1. BUAT SKEMA KHUSUS FORM (Client-Friendly)
...
export const verifikasiDonasiFormSchema = z.object({
  // Menggunakan properti message yang simpel dan bebas error TypeScript
...
// 2. SKEMA UNTUK VALIDASI API (Menggunakan skema form di dalamnya)

...
exports.DonaturValidation = void 0;
const zod = __importStar(require("zod"));
class DonaturValidation {
}
exports.DonaturValidation = DonaturValidation;
DonaturValidation.REGISTER = zod.object({
    body: zod.object({
...
DonaturValidation.LOGIN = zod.object({
    body: zod.object({
        email: zod.string().min(1, "Email is required field").email(),
        password: zod.string().min(1, "Password is required field"),
    }),
});
//# sourceMappingURL=donatur-validation.js.map
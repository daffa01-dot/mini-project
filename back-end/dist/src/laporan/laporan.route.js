...
const laporanUpload = new multerMiddleware_1.MulterMiddleware("memoryStorage").upload(5 * 1024 * 1024);
laporanRouter.get("/detail/:id", laporan_controler_1.LaporanController.getDetail);
laporanRouter.patch("/:id", auth_middleware_1.AuthMiddleware.authenticated(secretKey), auth_middleware_1.AuthMiddleware.authorized([client_1.Role.SUPER_ADMIN, client_1.Role.SHELTER]), laporanUpload.single("fotoSatwa"), laporan_controler_1.LaporanController.update);
